                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8">
                                ...
                                <input
                                    ...
                                    autocomplete="off"
                                    v-model="search"
                                    v-on:keyup.enter="buscarTareas"
                                />
                                {{ search }}
                            </div>
                            <div class="col-lg-4 col-md-4">
                               <button @click="buscarTareas()" class="btn btn-info">
                                            BUSCAR
                                </button>
                            </div>
                        </div>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr v-for="task in tasks" :key="task.id">
                                    ...
                                    <td>{{ task.finished }}</td>
                                    <td>
                                        <button @click="update = true; openModal(task);" class="btn btn-warning">
                                            EDITAR
                                        </button>
                                    </td>
                                    <td>
